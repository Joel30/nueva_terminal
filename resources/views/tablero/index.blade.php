                ...
                <tr>
                    ...
                    <td>
                        <div class="row justify-content-start">
                            <div class="col-4">
                                <a href="{{route('viaje.editar', $viaje)}}"><input type=image src="{{asset('images/edit.png')}}" width="20" height="20"></a>
                            ...
                            <div class="col-4">
                                <form action="{{route('viaje.eliminar', $viaje)}}" method="POST">
                                    ...
                                    <input type=image src="{{asset('images/delete.png')}}" width="20" height="20" onclick="return confirm('Esta seguro de eliminar el viaje con id: {{ $viaje->id}}')">
                                </form>
                            </div>
                        </div>                        
                    </td>
